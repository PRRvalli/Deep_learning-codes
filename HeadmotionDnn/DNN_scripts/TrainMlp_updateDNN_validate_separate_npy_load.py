...
#xname = sys.argv[2];
#yname = sys.argv[3];
xtrainfile = sys.argv[2];
ytrainfile = sys.argv[3];
#print xname
#print yname
mdlfile = sys.argv[6]; #This is the previous iteration mdl file
xvalidfile = sys.argv[4];
yvalidfile = sys.argv[5];
...
Xtrain = numpy.load(xtrainfile)
#Xtrain = Xtrain[0,:]
#Xtrain = numpy.transpose(Xtrain)
print Xtrain.shape

Ytrain = numpy.load(ytrainfile)
#Ytrain = Ytrain[0,:]
...
XValid = numpy.load(xvalidfile) 
#XValid = XValid[0,:]
#XValid = numpy.transpose(XValid)
print XValid.shape

YValid = numpy.load(yvalidfile)
#YValid = YValid[0,:]
